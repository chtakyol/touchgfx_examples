...
void Button_Start(void *argument);
...
int main(void)
{
  ...
  Button_TaskHandle = osThreadNew(Button_Start, NULL, &Button_Task_attributes);
...
/* USER CODE BEGIN Header_Button_Start */
/**
* @brief Function implementing the Button_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Button_Start */
void Button_Start(void *argument)
{
  /* USER CODE BEGIN Button_Start */
  pButtonsInit();
  /* Infinite loop */
  for(;;)
  {
